...
const CartItemSchema = CollectionSchema(
  ...
  links: {
    r'product': LinkSchema(
      id: -4884361594626549792,
      name: r'product',
      target: r'ProductModal',
      single: true,
    ),
    r'bill': LinkSchema(
      id: -6850746919522672199,
      name: r'bill',
      target: r'BillModal',
      single: true,
    )
...
List<IsarLinkBase<dynamic>> _cartItemGetLinks(CartItem object) {
  return [object.product, object.bill];
}

void _cartItemAttach(IsarCollection<dynamic> col, Id id, CartItem object) {
  object.id = id;
  object.product
      .attach(col, col.isar.collection<ProductModal>(), r'product', id);
...
extension CartItemQueryFilter
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> dateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> dateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> dateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> dateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> rateEqualTo(
    double value, {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> rateGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> rateLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> rateBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CartItemQueryLinks
    on QueryBuilder<CartItem, CartItem, QFilterCondition> {
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> product(
      FilterQuery<ProductModal> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'product');
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> productIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'product', 0, true, 0, true);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> bill(
  ...
  QueryBuilder<CartItem, CartItem, QAfterFilterCondition> billIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQuerySortBy on QueryBuilder<CartItem, CartItem, QSortBy> {
  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByRate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rate', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByRateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rate', Sort.desc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> sortByTotalDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQuerySortThenBy
  ...
  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
  ...
  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByRate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rate', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByRateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rate', Sort.desc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByTotal() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.asc);
    });
  }

  QueryBuilder<CartItem, CartItem, QAfterSortBy> thenByTotalDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'total', Sort.desc);
    });
  }
...
extension CartItemQueryWhereDistinct
  ...
  QueryBuilder<CartItem, CartItem, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, CartItem, QDistinct> distinctByRate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'rate');
    });
  }

  QueryBuilder<CartItem, CartItem, QDistinct> distinctByTotal() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemQueryProperty
  ...
  QueryBuilder<CartItem, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CartItem, int, QQueryOperations> qtyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'qty');
    });
  }

  QueryBuilder<CartItem, double, QQueryOperations> rateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'rate');
    });
  }

  QueryBuilder<CartItem, double, QQueryOperations> totalProperty() {
    return QueryBuilder.apply(this, (query) {
